...
const data = [
  {
    icon: require("./assets/company_logo/logo1.png"),
  ...
  {
    icon: require("./assets/company_logo/logo2.webp"),
  ...
  {
    icon: require("./assets/company_logo/logo3.png"),
    title: "Erection (8MW)",
  ...
  {
    icon: require("./assets/company_logo/logo5.png"),
  ...
  {
    icon: require("./assets/company_logo/logo12.jpeg"),
  ...
  {
    icon: require("./assets/company_logo/logo13.avif"),
  ...
  {
    icon: require("./assets/company_logo/logo14.jpg"),
