...
const AboutHeader = () => {
  ...
  const logoUrl = `https://cloud.appwrite.io/v1/storage/buckets/6791ced30003cf1d6c04/files/67925bc8002ed225e28c/view?project=6790c07f0018598d5209&project=6790c07f0018598d5209&mode=admin`; // Update with the actual file name in the bucket
